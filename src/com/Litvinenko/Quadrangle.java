...
public abstract class Quadrangle extends GeometricFigure {
    ...
    Quadrangle(double a_x0, double a_y0, double b_x0, double b_y0, double c_x0, double c_y0, double d_x0, double d_y0) {
        a_x = a_x0;
        a_y = a_y0;
        b_x = b_x0;
        b_y = b_y0;
